...
app.post('/rpc/get_lesson_with_content', authMiddleware, async (req, res) => {
    try {
        const response = await fetch(`${POSTGREST_URL}/rpc/get_lesson_with_content`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/rpc/get_all_lessons_with_content', authMiddleware, async (req, res) => {
    try {
        const response = await fetch(`${POSTGREST_URL}/rpc/get_all_lessons_with_content`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/rpc/create_lesson_with_content', authMiddleware, async (req, res) => {
    try {
        const response = await fetch(`${POSTGREST_URL}/rpc/create_lesson_with_content`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
app.post('/rpc/update_lesson_with_content', authMiddleware, async (req, res) => {
    try {
        const response = await fetch(`${POSTGREST_URL}/rpc/update_lesson_with_content`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
