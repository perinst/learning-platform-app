...
INSERT INTO users (id, email, password_hash, name, role, created_at) VALUES
    ('00000000-0000-0000-0000-000000000001', 'admin@example.com', crypt('admin123', gen_salt('bf')), 'Admin User', 'admin', '2024-01-01 00:00:00'),
    ('00000000-0000-0000-0000-000000000002', 'user@example.com', crypt('user123', gen_salt('bf')), 'John Doe', 'user', '2024-01-15 00:00:00'),
    ('00000000-0000-0000-0000-000000000003', 'jane@example.com', crypt('user123', gen_salt('bf')), 'Jane Smith', 'user', '2024-02-01 00:00:00');

-- Insert mock lessons (using BIGINT IDs)
INSERT INTO lessons (id, title, description, content, category, status, created_by, created_at, summary, image_url, grade) VALUES
    (
        1,
...
INSERT INTO progress (user_id, lesson_id, completed, last_accessed, progress) VALUES
    ('00000000-0000-0000-0000-000000000002', 1, true, '2024-02-15 00:00:00', 100),
    ('00000000-0000-0000-0000-000000000002', 2, false, '2024-02-20 00:00:00', 60),
    ('00000000-0000-0000-0000-000000000002', 3, false, '2024-02-18 00:00:00', 30);
